...
const InboxUsers = () => {
    ...
    return (
        <ul className="inbox-users-list">
            <div className="inbox-users-list__header-title">
                <h2>Mesajlar</h2>
            </div>
            <li>
                <Avatar creatorImg={avatarImage} className='avatar-small' />
                <div className="inbox-users-list__title">
                    <h3>Corey Cimmons</h3>
                    <small>Hello how are you. I want ...</small>
                </div>
            </li>
            <li>
                <Avatar creatorImg={avatarImage} className='avatar-small' />
